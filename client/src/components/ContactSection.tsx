        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="space-y-6">
              <div>
                <p className="text-sm text-slate-500 uppercase tracking-wider mb-2">Location</p>
                <p className="text-white text-lg font-medium">Silicon Valley, CA</p>
              </div>
              <div>
                <p className="text-sm text-slate-500 uppercase tracking-wider mb-2">Email</p>
                <a href="mailto:hello@savistatech.com" className="text-white text-lg font-medium hover:text-[hsl(var(--cyan))] transition-colors">hello@savistatech.com</a>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/[0.02] border border-white/10 rounded-3xl p-8 md:p-12 backdrop-blur-xl">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div>
                ...
                <input 
                  {...register("name")}
                  className="w-full bg-black/50 border border-white/10 rounded-xl px-5 py-4 text-white placeholder:text-slate-600 focus:outline-none focus:border-[hsl(var(--cyan))] focus:ring-1 focus:ring-[hsl(var(--cyan))]/50 transition-all"
              ...
              <div>
                ...
                <textarea 
                  {...register("message")}
                  rows={4}
                  className="w-full bg-black/50 border border-white/10 rounded-xl px-5 py-4 text-white placeholder:text-slate-600 focus:outline-none focus:border-[hsl(var(--cyan))] focus:ring-1 focus:ring-[hsl(var(--cyan))]/50 transition-all resize-none"
